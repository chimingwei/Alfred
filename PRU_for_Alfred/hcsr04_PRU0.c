...
int main(void) {
	...
	prussdrv_exec_program(PRU_NUM0, "hcsr04.bin");

	/* Get measurements */
	// int i = 0;
	while ((pruData[0] / 58.44) < 1000.00 || (pruData[1] / 58.44) < 1000.00) {
		...
		printf("Distance = %.2f cm & %.2f\n", (float) pruData[0] / 58.44,(float) pruData[1] / 58.44);
		sleep(1);
	}
